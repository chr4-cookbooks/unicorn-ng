...
attribute :listen,            kind_of: [String, Integer],       default: node['unicorn-ng']['config']['listen']
...
attribute :mode,              kind_of: [String, Integer],       default: node['unicorn-ng']['config']['mode']
